...
namespace OctaneSdkExamples
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void buttonStart_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                reader.Connect(textBoxHostName.Text);
            ...
            catch (OctaneSdkException ex)
            {
                ...
                listTags.Items.Add($"An Octane SDK exception has occurred : {ex.Message}");
            }
            catch (Exception ex)
            {
                ...
                listTags.Items.Add($"An exception has occurred : {ex.Message}");
            }
        }
        ...
        {
            // Allow for the Hostname to be changed
            try
            {
