    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                // The following registry keys should be set to enable Tls13 in Windows, otherwise it defaults to Tls12
                // Path - [HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\TLS 1.3\Client]
                // Keys - "DisabledByDefault" = dword:00000000, "Enabled" = dword:00000001
                const bool useTLS = true;
                reader.Connect(hostname, useTLS, TlsProtocols.Tls13);
