...
namespace OctaneSdkExamples
{
    class Program
    {
        ...
        static void DisplayCurrentSettings()
        {
            ...
            Console.WriteLine("Impinj regulatory region : {0}", settings.ImpinjRegulatoryRegion);
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                Console.WriteLine("Antenna count : {0}", features.AntennaCount);
                Console.WriteLine("Communications standard : {0}", features.CommunicationsStandard);
                Console.WriteLine("Max tx power : {0} dBm\n", features.TxPowers.Count > 0 ? features.TxPowers[features.TxPowers.Count - 1].Dbm : 0);
