    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            #region SetReaderConfigWithXML
            {
                ...
                try
                {
                    FileStream fs = new(@"..\..\..\setReaderConfig.xml", FileMode.Open);
            ...
            #region ADDAccessSpecWithXML
            {
                ...
                try
                {
                    FileStream fs = new(@"..\..\..\addAccessSpec.xml", FileMode.Open);
                    StreamReader sr = new(fs);
                    string s = sr.ReadToEnd();
                    fs.Close();
                ...
                MSG_ADD_ACCESSSPEC_RESPONSE rsp = reader.ADD_ACCESSSPEC(msg, out MSG_ERROR_MESSAGE msg_err, 12000);
                if (rsp != null)
                {
                    if (rsp.LLRPStatus.StatusCode != ENUM_StatusCode.M_Success)
                    {
            ...
            #region ADDAccessSpec
            {
                ...
                targetTag[0] = new PARAM_C1G2TargetTag
                {
                    ...
                    MB = new TwoBits(1),
                    Pointer = 16,
                    TagData = LLRPBitArray.FromHexString("300035"),
                    TagMask = LLRPBitArray.FromHexString("f800ff")
                };
            ...
            #region EnableAccessSpec
            {
                ...
                {
                    MSG_ID = msgID++,
                    AccessSpecID = 23   // this better match the ACCESSSPEC we created above
                };
            ...
            for (int delay = 0; delay < 5; delay++)
            {
                ...
                #region PollReaderReports
                {
                    ...
                    MSG_GET_REPORT msg = new()
                    {
                        MSG_ID = msgID++
                    };
                    reader.GET_REPORT(msg, out MSG_ERROR_MESSAGE msg_err, 10000);
                }
                #endregion
            }
            ...
            #region Clean Up Reader Configuration
            {
                ...
                {
                    ResetToFactoryDefault = true,
                    MSG_ID = msgID++ // note this doesn't need to bet set as the library will default
                };
