    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            #region getReaderCapabilities
            {
                ...
                PARAM_TransmitPowerLevelTableEntry entry = uhf.TransmitPowerLevelTableEntry[^1];
            ...
            #region getReaderConfig
            {
                ...
                MSG_GET_READER_CONFIG_RESPONSE msg_rsp =
                          reader.GET_READER_CONFIG(cap, out MSG_ERROR_MESSAGE msg_err, 8000);
