...
namespace LLRPTest
{
    ...
    public partial class MainFrm : Form
    {
            ...
            try
            {
                for (int i = 0; i < msg.TagReportData.Length; i++)
                {
                    if (msg.TagReportData[i].EPCParameter.Count > 0)
                    {
                        ...
                        {
                            listBox1.Items.Add(epc + ":" + msg.TagReportData[i].TagSeenCount.TagCount.ToString() + ":" + msg.TagReportData[i].PeakRSSI.PeakRSSI.ToString());
        ...
        private void DISABLE_ACCESSPEC()
        {
            ...
            MSG_DISABLE_ACCESSSPEC_RESPONSE rsp = reader.DISABLE_ACCESSSPEC(msg, out msg_err, 12000);
            if (rsp != null)
            {
                textBox2.Text = rsp.ToString();
            }
        ...
        private void GET_ACCESSSPEC()
        {
            ...
            MSG_GET_ACCESSSPECS_RESPONSE rsp = reader.GET_ACCESSSPECS(msg, out msg_err, 12000);
        ...
        private void Get_Reader_Capability()
        {
            ...
            MSG_GET_READER_CAPABILITIES_RESPONSE rsp = reader.GET_READER_CAPABILITIES(msg, out msg_err, 12000);
            if (rsp != null)
            {
                textBox2.Text = rsp.ToString();
            }
        ...
        private void Get_RoSpec()
        {
            ...
            MSG_GET_ROSPECS_RESPONSE rsp = reader.GET_ROSPECS(msg, out msg_err, 12000);
            if (rsp != null)
            {
                textBox2.Text = rsp.ToString();
            }
        ...
        private void Add_RoSpec()
        {
            ...
            msg.ROSpec.ROBoundarySpec.ROSpecStartTrigger.ROSpecStartTriggerType = ENUM_ROSpecStartTriggerType.GPI;
        ...
        private void Enable_Impinj_Extension()
        {
            ...
            if (msg_rsp != null)
            {
                textBox2.Text = msg_rsp.ToString();
            }
            else if (msg_err != null)
            {
                textBox2.Text = msg_err.ToString();
